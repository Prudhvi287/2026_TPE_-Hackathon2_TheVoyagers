...
![Build](https://img.shields.io/badge/QGC-v5.0.3-brightgreen)
![License](https://img.shields.io/badge/License-Apache2%2FGPLv3-red)
![Hardware](https://img.shields.io/badge/Hardware-Flight%20Controller%20Verified-blue)

---

## What is AutoPilot GCS?

AutoPilot GCS is a custom drone ground control station built on top of [QGroundControl](https://github.com/mavlink/qgroundcontrol). We compiled QGC from source and added an **AI Intelligence Module** — a new panel that lets operators select autonomous flight algorithms in real time. The system has been verified with a real flight controller via MAVLink.

This is the **first module** of a larger autonomy product being developed for the *Technology, Product & Entrepreneurship* course.
...
## Tech Stack
- **Base:** QGroundControl v5.0.3 compiled from source
- **UI:** Qt 6.10.2 + QML + QtMultimedia
